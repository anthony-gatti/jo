...
<ul><li id="menu-item-12"><a href="/">Hello</a></li>
<li id="menu-item-13"><a href="/#aboutus">About</a></li>
<li id="menu-item-14"><a href="/#project_thumbs" class="active-scrollsection">Work</a></li>
<li id="menu-item-15"><a href="/#contact" >contact</a></li>
</ul>
</div>

<div id="entry-wrap">
<div id="project_gallery" class="low_section">
                       
            
            	<a href="/#project_thumbs" class="button close"></a>
...
<script src="<?php bloginfo('stylesheet_directory'); ?>/js/slick.js"></script>
<script>
// Gallery http://www.owlgraphic.com/owlcarousel/
...
$(".attachment-full").on("mousedown", cursor_grabbing )
$(".attachment-full").on("mouseup", cursor_grab )

function cursor_grabbing(){$(this).css('cursor','-webkit-grabbing')}

function cursor_grab(){$(this).css('cursor','-webkit-grab')}
</script>
